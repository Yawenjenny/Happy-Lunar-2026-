...
const App: React.FC = () => {
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-[#8F1E1A] relative overflow-hidden">
      ...
      <h1 className="text-4xl md:text-5xl font-bold text-yellow-400 mb-6 drop-shadow-sm tracking-wide z-10">
        马年大吉
      </h1>

      <div className="z-10 shadow-2xl rounded-xl overflow-hidden border-4 border-yellow-600 bg-[#8F1E1A]">
        <SpringRunnerGame />
      </div>

      <div className="mt-4 flex flex-col items-center z-10 text-center">
